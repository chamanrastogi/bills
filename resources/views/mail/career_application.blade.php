                                                                                    ...
                                                                                    <table border="0" cellpadding="0"
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                ...
                                                                                                <td style="padding: 8px 0;">{{ $data['job_position'] }}</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td style="padding: 8px 0;">{{ $data['date_of_birth'] }}</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td style="padding: 8px 0; font-weight: bold;">Current Employer</td>
                                                                                                <td style="padding: 8px 0;">{{ $data['current_employer'] }}</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td style="padding: 8px 0; font-weight: bold;">IT Experience</td>
                                                                                                <td style="padding: 8px 0;">{{ $data['it_experience'] }}</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td style="padding: 8px 0; font-weight: bold;">Educational Qualification</td>
                                                                                                <td style="padding: 8px 0;">{{ $data['educational_qualification'] }}</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td style="padding: 8px 0; font-weight: bold;">Significant Roles Played</td>
                                                                                                <td style="padding: 8px 0;">{{ $data['significant_roles'] }}</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td style="padding: 8px 0; font-weight: bold;">Present Salary</td>
                                                                                                <td style="padding: 8px 0;">{{ $data['present_salary'] }}</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td style="padding: 8px 0; font-weight: bold;">Expected Salary</td>
                                                                                                <td style="padding: 8px 0;">{{ $data['expected_salary'] }}</td>
                                                                                            </tr>
                                                                                        </tbody>
                                                                                    </table>
                                                                                </td>
                                            ...
                                            <tr>
                                                <td class="content-cell" align="center"
                                                    ...
                                                    <p
                                                        ...
                                                        {{ date('Y') }} © {{ $template->site_title }} All Rights
                                                        Reserved</p>
